The developers thank all the open source libraries making GEMSEO-ssh possible.

External Dependencies
---------------------

GEMSEO-ssh depends on software with compatible licenses that are listed below.
...
GEMSEO-ssh source code includes software with compatible licenses that are listed below.

External application
--------------------

Some external applications are used by GEMSEO-ssh,
...
Some icons and fonts are used by GEMSEO-ssh or its documentation.
