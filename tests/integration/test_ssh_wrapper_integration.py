...
class TestSSHDisciplineWrapperIntegration:
...
class TestFileTransferWithDiscWithFiles:
    """Tests for file upload/download using DiscWithFiles.

    DiscWithFiles is available via the GEMSEO_PATH environment variable
    set in the Docker image to /workdir/discipline.py.
    """
